...
$script = <<<SCRIPT
	...
	background-image: url('/redcap/modules/swiss_army_{$version}/features/themes_hook/pics/stars.jpg');
...
#center {
	...
	background-image: url('/redcap/modules/swiss_army_{$version}/features/themes_hook/pics/stars.jpg');, linear-gradient(#eb01a5, #d13531); 
